// src/Component/Shared/Footer.jsx (CORREGIDO Y LIMPIO DE ESPACIOS IRREGULARES)

import React from "react";

// Adaptamos el fondo de bg-gray-900 a dark:bg-pink-900 para el tema oscuro
export default function Footer() {
  return (
    <footer className="bg-gray-900 dark:bg-pink-900 text-gray-300 mt-12 py-10">
      <div className="container mx-auto px-4">
        {/* GRID PRINCIPAL DEL FOOTER (3 Columnas) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 border-b border-gray-700 dark:border-pink-800 pb-8">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-grow p-2 rounded-md bg-gray-700 border border-gray-600 text-sm focus:outline-none focus:ring-2 focus:ring-pink-500"
              />
              <button className="bg-pink-600 hover:bg-pink-500 text-white px-4 py-2 rounded-md text-sm font-semibold transition">
                Suscribirse
              </button>
            </div>
        ...
        <div className="text-center pt-6 text-sm text-gray-500">
          <p>
            &copy; {new Date().getFullYear()} Mi Lucero Carteras y Accesorios.
